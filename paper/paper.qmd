...
ggplot(deaths_trend, aes(x = occ_year, y = Total_Deaths)) +
  geom_line(color = "darkred") +  # Line for the trend
  geom_point(color = "darkred") +  # Points for each year
...
#| label: fig-shooting-trends
#| fig-cap: "Trend of Shootings Over Time"
...
ggplot(hourly_pattern, aes(x = occ_hour, y = n)) +
  geom_line(color = "darkred") +  # Line for the trend
  geom_point(color = "darkred") +  # Points for each hour
...
(@fig-shooting-trends) Patterns shows incidents occur during late-night hours, which suggests that increased community support and policing during these times could help reduce incidents. Programs that provide safe spaces and activities during the night might be effective in these areas.
